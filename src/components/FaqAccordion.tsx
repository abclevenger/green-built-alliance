  ...
  return (
    <section className={className} aria-labelledby={id}>
      ...
      <div className="mt-8 divide-y divide-[color:var(--gb-border)] overflow-hidden rounded-2xl border border-[color:var(--gb-border)] bg-[color:var(--gb-surface)] shadow-sm">
        {items.map((item, i) => (
          <details key={i} className="group border-0 border-[color:var(--gb-border)] bg-[color:var(--gb-surface)] p-0 open:bg-[color:var(--gb-surface-muted)]/40">
            <summary className="cursor-pointer list-none px-5 py-4 text-left text-sm font-bold text-[color:var(--gb-text)] marker:hidden md:px-6 md:text-base [&::-webkit-details-marker]:hidden">
            ...
            <div className="border-t border-[color:var(--gb-border)]/80 px-5 pb-5 pt-0 md:px-6">
              <p className="pt-4 text-sm leading-relaxed text-[color:var(--gb-text-muted)] md:text-[0.9375rem]">
                {item.answer}
              </p>
            </div>
          </details>
